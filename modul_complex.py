...
# измененную строку (без двух элементов первого действия) , индекс куда нужно будет вставить результат выражения
def serch_two_elems(data,index_mark):
    ...
    return kke(elem_1),kke(elem_2),data,index_left,index_right
#
